...
- [~] summary 已可通过 `scripts/export_vcneb_metrics.py` 导出逐 image 反应坐标、焓、晶格长度/角度、体积、应力和 NEB 力 CSV；`scripts/plot_vcneb_metrics.py` 已生成论文级焓垒/晶格/体积/力四联图，并覆盖 HfO₂ linear-cell 对照，关键键长和模式投影仍待补齐。
