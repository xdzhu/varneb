...
- 27678924 的线性 cell 插值对照仍在运行：截至本轮已完成 step 20，fmax 从 0.965655 降至 0.312284 eV/A，连续下降且 64 个 worker manifest 记录均为 ok；必须继续观察多个完整 step，完成后再与 log-strain 7/9-image 结果比较，不因单次回弹提前取消，也不在该分支启动 CI。
