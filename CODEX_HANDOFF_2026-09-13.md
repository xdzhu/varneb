...
- 截至 2026-09-14 01:10 左右，`27678406` 已完成 step 10（`fmax=0.406810 eV/A`），`27678407` 已完成 step 6（`fmax=0.655064 eV/A`）；两条作业仍 RUNNING，manifest 分别只记录 `[1,2,3]` 与 `[1,2,3,4,5,6,7]`，ABACUS 错误计数均为 0。
...
- 截至同一检查，CI `27678507` 已完成 step 1（`fmax=0.083775 eV/A`），manifest 记录 5 个内部 image；当前仍 RUNNING、无错误 task。
