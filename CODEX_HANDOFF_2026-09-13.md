...
- 截至 2026-09-14 00:00 检查，`27678218` 仍为 RUNNING，已写入完整 VCNEB step 13，`fmax=0.201292 eV/A`；manifest 共 43 条批次记录，均只含 image 1--5，7 个 ABACUS image 目录均确认 32 MPI、无错误退出。当前正在进行 step 14 的 5-image worker 波次。
