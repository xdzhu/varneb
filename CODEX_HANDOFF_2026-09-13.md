...
- 截至 2026-09-14 02:03:38，`27678406` 已完成 step 35（`fmax=0.100513 eV/A`），`27678407` 已完成 step 22（`fmax=0.329755 eV/A`）；两条作业仍 RUNNING，manifest 分别只记录 `[1,2,3]` 与 `[1,2,3,4,5,6,7]`，ABACUS 错误计数均为 0。
...
- 截至同一检查，CI `27678507` 已完成 step 27（`fmax=0.045674 eV/A`）；step 15--22 的回弹窗口已完整观察，step 23--27 重新下降，manifest 记录 5 个内部 image；当前仍 RUNNING、无错误 task。
