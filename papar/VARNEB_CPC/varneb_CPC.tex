...
force constants with Phonopy \cite{Togo2015}. The mass-weighted spectrum contains
a triply degenerate unstable subspace at $-217.474$ cm$^{-1}$. After applying the
...
reconstruction residual is below $5.2\times10^{-16}\sqrt{\mathrm{amu}}$\AA{}.
The $127.891$ cm$^{-1}$ stable triplet also participates (maximum coordinate norm
